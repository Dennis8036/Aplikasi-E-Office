  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <img src="<?= base_url('images/img/' . $setting->logo_dashboard) ?>"  class="logo-dashboard" width="120px">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('Home/penghuni')?>">
              <i class="ti-volume menu-icon"></i>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('Home/dokumen')?>">Dokumen</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('Home/suratmasuk')?>">Surat Masuk</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('Home/suratkeluar')?>">Surat Keluar</a></li>
              </ul>
            </div>
          </li>
